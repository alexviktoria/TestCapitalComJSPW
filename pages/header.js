  ...
  async clickSwingTrading() {
    ...
    await test.step('Click Position Trading', async () => {
      if (await this.SwingTrading.isVisible()) {
        ...
        console.log(
          `For test on '${language}' language the page "Education->Swing Trading" doesn't exist on production`,
        );
        test.skip();
      }
    });
  ...
  async clickSharesTrading() {
    ...
    await test.step('Click Shares Trading', async () => {
      if (await this.SharesTrading.isVisible()) {
        ...
        console.log(
          `For test on '${language}' language the page "Education->Shares Trading" doesn't exist on production`,
        );
        test.skip();
      }
    });
