...
class SignUpPage {
  constructor(page) {
    ...
    // header name
    this.LoginLinkForm = page.locator(
      ".signup-form > .form-container-small-header > p > .l_btn_signup",
    );
    this.LoginLinkFormOnPlatform = page.locator(".txt__link");
    this.PolicyLink = page.locator(
      '.signup-form a[href*="terms-and-policies"]',
    );
    this.PolicyLinkOnPlatform = page.locator(".checkbox__link");
    this.CloseSignUpFormBtn = page.locator(
      "#s_overlay .form-container-white .button-cleared",
    );
    ...
    this.ContinueButton = page.locator(
      ".signup-form > .form-container-small-content > form > .btn",
    );
